...
local function GetTipsData()
    ...
    if table.IsEmpty(HORDE.tips) then
        ...
        if GetConVar("horde_default_item_config"):GetInt() == 1 and GetConVar("horde_external_lua_config"):GetString() == "" then
            ...
            AddTip("The Barrett AMR has the highest single-shot damage.")
        ...
        if GetConVar("horde_default_class_config"):GetInt() == 1 then
            AddTip("ASSAULT specializes in auto-rifles & SMGs .")
            ...
            AddTip("GHOST specializes in sniper rifles.")
            ...
            AddTip("ENGINEER specializes in minions.")
        ...
        AddTip("Decay debuff blocks health recovery.")
        AddTip("Necrosis debuff will instantly down you.")
    end
